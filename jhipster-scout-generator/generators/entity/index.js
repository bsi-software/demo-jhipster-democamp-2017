...
module.exports = generator.extend({
    ...
    initializing: {
        ...
        displayLogo() {
            console.log(chalk.white('Running ' + chalk.bold('JHipster generator-jhipster-eclipse-scout') + ' Generator! ' + chalk.yellow('v' + packagejs.version + '\n')));
        },
        validate() {
    ...
    writing() {
        ...
        if (this.yourOptionKey){
            console.log('\n' + chalk.bold.green('generator-jhipster-eclipse-scout enabled'));
        }
    }
});
