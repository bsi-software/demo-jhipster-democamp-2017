...
public class TalkOrganizerApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(TalkOrganizerApp.class);

    private final Environment env;

    public TalkOrganizerApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes TalkOrganizerApp.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TalkOrganizerApp.class);
