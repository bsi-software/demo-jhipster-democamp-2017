...
public class SpeakerResourceIntTest {
    ...
    public void setup() {
        ...
        SpeakerResource speakerResource = new SpeakerResource(speakerService);
    ...
    public void createSpeaker() throws Exception {
        ...
        assertThat(testSpeaker.getPhoneNumber()).isEqualTo(DEFAULT_PHONE_NUMBER);
    }
    ...
    public void updateSpeaker() throws Exception {
        ...
        SpeakerDTO speakerDTO = speakerMapper.speakerToSpeakerDTO(updatedSpeaker);
        ...
        assertThat(testSpeaker.getPhoneNumber()).isEqualTo(UPDATED_PHONE_NUMBER);
    }
